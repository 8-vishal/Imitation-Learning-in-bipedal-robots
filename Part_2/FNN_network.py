...
class DQNFNN(nn.Module, ABC):
    def __init__(self, L_R, In_Dims, Layer1_dims, Layer2_dims,
        ...
        self.layer_1 = nn.Linear(*self.In_Dims, self.Layer1_dims)
        self.layer_2 = nn.Linear(self.Layer1_dims, self.Layer2_dims)
        self.layer_3 = nn.Linear(self.Layer2_dims, 256)
        self.layer_4 = nn.Linear(256, 512)
        self.layer_5 = nn.Linear(512, self.N_Action)
